...
- [ ] Describe Middleware?
Middleware is simply a function that extends software.

- [ ] Describe a Resource?

- [ ] What can the API return to help clients know if a request was successful?
To know if a request was successful, the API needs to send a response to the client. 

- [ ] How can we partition our application into sub-applications?
We partition our application into sub-applications by creating routes.
